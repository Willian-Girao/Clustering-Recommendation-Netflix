...
if not os.path.exists('top_1k_active_users-movies_list'):
	os.makedirs('top_1k_active_users-movies_list')
...
for file in training_files:
	...
	for key, value in file_content.items():
		...
		# open user file
		target_folder = 'C:/Users/willi/UFF/Machine Learning/download/top_1k_active_users-movies_list'
