...
movies_ids_list = []
movies_ids_file = open("top_1k00_rated_movies.txt", "r")
...
# Final matrix file
matrix_file = open('userId_X_movieId_ratings_matrix.txt', "a+")

# Getting all files within target directory.
users_files = os.listdir('top_1k_active_users/')
...
for user_id in user_ids_sorted:
	...
	user_file = open('top_1k_active_users/' + str(user_id) + '_movies.txt', "r")
	print(user_id)
